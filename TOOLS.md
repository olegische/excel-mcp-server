...
```python
create_workbook(filepath: str) -> dict[str, Any]
```

- `filepath`: Path where to create workbook
- Returns: JSON object with a success message and workbook details.
...
- Returns: JSON object containing workbook metadata.
...
```python
merge_cells(filepath: str, sheet_name: str, start_cell: str, end_cell: str) -> dict[str, Any]
```
...
```python
unmerge_cells(filepath: str, sheet_name: str, start_cell: str, end_cell: str) -> dict[str, Any]
```
...
```python
apply_formula(filepath: str, sheet_name: str, cell: str, formula: str) -> dict[str, Any]
```
...
- Returns: JSON object with the validation result.
...
```python
get_data_validation_info(filepath: str, sheet_name: str) -> dict[str, Any]
```
